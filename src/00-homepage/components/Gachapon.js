...
function Gachapon() {
  ...
  const eggSvg = useRef(null)
  const [onSwitch, setOnSwitch] = useState(false)
  const [goEgg, setGoEgg] = useState(false)
  const [prize, setPrize] = useState([])
  const [getwinner, setGetWinner] = useState(false)

  const handleRand = async () => {
    try {
      const response = await axios.get('http://localhost:3004/home/ganchapon')

      const eggData = response.data.eggRows
      //設定到state裡
      setPrize(eggData)
    } catch (e) {
      // 錯誤處理
  ...
  return (
    <>
      <div className="r-gachapon-container">
          ...
          {prize.map((v, i) => {
            return (
              <div className="r-winner" key={i}>
                <span className="r-product-prize">
                  今日為您特別推薦 :
                  <br />
                  {v.product_name}
                </span>
        ...
        <div className="r-gachapon">
          <svg
            className={onSwitch ? 'r-switch active' : 'r-switch'}
            viewBox="0 0 154 155"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            ref={switchSvg}
          ...
          >
            ...
            />
            <path
              d="M105 902L112.5 646H511.5L519 894.5L105 902Z"
              fill="#fad249"
              stroke="#57162F"
              strokeWidth="10"
              strokeLinecap="round"
            ...
            <g
              ref={eggSvg}
              className={goEgg ? 'r-egg active' : 'r-egg'}
              onClick={handlePrize}
            >
              <circle
                cx="313.5"
            ...
            >
              ...
              <circle
                ...
                cy="105.89"
                r="47"
                transform="rotate(-87.8779 424.89 105.89)"
                fill="white"
                stroke="#57172F"
                strokeWidth="10"
              />
              ...
              <circle
                ...
                cy="79.0678"
                r="47"
                transform="rotate(-71.051 273.068 79.0678)"
                fill="#F3D478"
                stroke="#57172F"
                strokeWidth="10"
              />
              ...
              <circle
                ...
                cy="178.423"
                r="47"
                transform="rotate(151.74 70.4229 178.423)"
                fill="white"
                stroke="#57172F"
                strokeWidth="10"
              />
              ...
              <circle
                ...
                cy="68.6351"
                r="47"
                transform="rotate(113.957 356.635 68.6351)"
                fill="white"
                stroke="#57172F"
                strokeWidth="10"
              />
              ...
              <circle
                ...
                cy="167.998"
                r="47"
                transform="rotate(-5.8118 437.998 167.998)"
                fill="#E5A0B9"
                stroke="#57172F"
                strokeWidth="10"
              />
              ...
              <circle
                ...
                cy="163.026"
                r="47"
                transform="rotate(-115.664 261.391 163.026)"
                fill="white"
                stroke="#57172F"
                strokeWidth="10"
              />
              ...
              <circle
                ...
                cy="217.058"
                r="47"
                transform="rotate(-71.051 384.423 217.058)"
                fill="white"
                stroke="#57172F"
                strokeWidth="10"
              />
